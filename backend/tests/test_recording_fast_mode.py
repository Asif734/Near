...
def test_recording_fast_mode_keeps_qa_and_increases_parallelism(tmp_path, monkeypatch):
    ...
    assert engine.TRANSCRIPT_QA_ENABLED is True
    assert engine.TRANSLATION_QA_ENABLED is True
